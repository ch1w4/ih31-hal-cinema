        ...
        <div className="w-full max-w-[560px] rounded-[18px] border border-[#2a2a2a] bg-[#0d0d0d] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.4)] md:p-6">
          ...
          <form className="mx-auto max-w-[460px] space-y-4">
            <div>
              ...
              <input
                type="email"
                className="w-full rounded-md border border-[#444] bg-[#121212] px-3 py-2.5 text-base text-white placeholder-gray-500 outline-none transition focus:border-[#d9b35a] focus:ring-2 focus:ring-[#d9b35a]/20"
              />
            </div>
          ...
          <div className="mt-5 border-t border-[#2b2b2b] pt-4 text-center">
            <p className="mb-2 text-[9px] tracking-[0.12em] text-gray-400 uppercase">or</p>
            <button
          ...
          <div className="mt-8 text-center">
            <p className="mb-3 text-sm text-gray-400">会員登録がまだの方</p>
            <Link
              href="/register"
